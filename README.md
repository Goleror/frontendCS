...
### 🚀 Запуск проекта (Windows, macOS, Linux, WSL)
...
Откроется интерактивное меню для выбора платформы разработки. Все остальное будет настроено автоматически!

**Альтернативные методы:**

```bash
# Linux/Mac - используя bash скрипт
./run.sh

# Все платформы - прямой запуск
npm run dev
```

### Использование Project Manager

Для удобного управления проектом есть несколько способов:

**1️⃣ Быстрый запуск с выбором платформы (рекомендуется):**
```bash
npm run launch
```

**2️⃣ Платформо-зависимый запуск:**
```bash
# Linux/Mac
./run.sh
...
**2️⃣ Project Manager (интерактивное меню):**
```bash
python3 manage.py
```
...
### 🛠️ Project Manager - Опции

При запуске `python3 manage.py` доступны:
- 🚀 **Запустить dev сервер** - Локальный сервер на http://localhost:5000
- 🏗️ **Собрать проект** - Production сборка
- 📦 **Установить зависимости** - npm install
- 🔍 **Проверить систему** - Проверка зависимостей и конфигурации
- 📋 **Просмотреть логи** - Просмотр backend/frontend логов
- 🗑️ **Очистить логи** - Удаление файлов логов
